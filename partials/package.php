<section id="paket" class="section rk-section-soft">
  <div class="container">
    <div class="text-center mb-5">
      <span class="badge rk-badge mb-2">UNLIMITED PACKAGE</span>
    ...
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="package-card h-100 <?= $p['featured'] ? 'featured' : '' ?>">
          ...
          <div class="display-6 fw-800 text-rk"><?= htmlspecialchars($p['price']) ?><small class="fs-6 text-muted fw-400"><?= htmlspecialchars($p['period']) ?></small></div>
