  ...
  <div class="container">
    <div class="redeem-banner row align-items-center g-4">
      ...
      <div class="col-lg-4 text-lg-end">
        <button type="button" class="btn btn-light btn-redeem fw-600" data-bs-toggle="modal" data-bs-target="#modalRedeem">Redeem Sekarang <i class="bi bi-ticket-perforated"></i></button>
      </div>
    </div>
  </div>
</section>
