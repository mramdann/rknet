  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-3">
        ...
        <li class="nav-item"><button class="btn btn-rk" type="button" data-bs-toggle="modal" data-bs-target="#modalLangganan">Berlangganan Sekarang <i class="bi bi-arrow-right"></i></button></li>
      </ul>
    </div>
  </div>
</nav>
