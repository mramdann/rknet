# dump-seed.ps1 — regenerasi database/seed.sql dari kondisi DB `dbstarlite` terkini.
...
$body = & $dump -h 127.0.0.1 -P 3382 -u root --no-create-info --complete-insert --skip-extended-insert --compact --no-tablespaces dbstarlite @tabel
