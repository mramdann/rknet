...
<?php include __DIR__ . '/partials/shell-open.php'; ?>
  ...
  <div class="d-flex align-items-center justify-content-between mb-4 no-print">
    ...
    <div class="d-flex gap-2">
      <?php if (!$lunas): ?><a href="#" class="btn btn-st"><i class="bi bi-credit-card me-1"></i>Bayar Sekarang</a><?php endif; ?>
  ...
  <div class="kartu kartu-pad invoice-sheet mx-auto">
    ...
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 pb-3 border-bottom">
      ...
      <div class="text-end">
        <h5 class="fw-800 text-st mb-1">INVOICE</h5>
    ...
    <div class="row justify-content-end pt-3">
      <div class="col-sm-6 col-md-5">
        ...
        <hr class="my-2">
        <div class="d-flex justify-content-between py-1"><span class="fw-700">Total</span><span class="fw-800 text-st fs-5"><?= formatRupiah($total) ?></span></div>
      </div>
    </div>
